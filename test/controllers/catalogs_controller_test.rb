...
class CatalogsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create catalog" do
    assert_difference('Catalog.count') do
      post catalogs_url, params: { catalog: { product_id: @catalog.product_id, vendor_id: @catalog.vendor_id } }
    end
  ...
  test "should update catalog" do
    patch catalog_url(@catalog), params: { catalog: { product_id: @catalog.product_id, vendor_id: @catalog.vendor_id } }
